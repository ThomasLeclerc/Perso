...
<div id="mainContainer">
    ...
    <div id="form_ajout">
        ...
        <form method="POST" action="Maj_discipline.php?action=1" onSubmit="return confirm('confirmez-vous l\'ajout ?')">
               <table>
                    <tr>
                   <td><label for="libelleDiscipline">Nom Discipline : </label></td><td><input type="text" name="libelleDiscipline" id="libelleDiscipline" onKeyUp="check_field_nom_discipline('libelleDiscipline')"></td>
                   <td id="error_libelleDiscipline"></td>
                   </tr>
                   <tr>
                       <td></td>
                       <td><input type="submit" value="Ajouter" onclick="return check_field_nom_discipline('libelleDiscipline')">
    ...
    <div id="form_modif">
        ...
        <form method="POST" action="Maj_discipline.php?action=3" onSubmit="return confirm('confirmez-vous la modification ?')">
               <table>
                   ...
                   <tr>
                       <td></td>
                       <td><input type="submit" value="Modifier" onClick="return check_field_nom_discipline('libelleDisciplineModif')">
